...
<head>
    <title>Membership FAQs | Holmer Green Squash & Racketball Club</title>
	...
	<meta name="Description" content="Membership FAQs"/>
    ...
    <div id="main">
        <?php include("../includes/header.php") ?>
            ...
            <div id="box-fullwidth">
                <div id="Heading1" style="position:relative; float:left; background-color:#284934; width:980px; height:40px; text-align:center; line-height:40px; "><a class="arial16white"><b>Membership Frequently Asked Questions</b></a></div>
		        
                <div id="Text1" style="position:relative; float:left; width:940px; height:auto; text-align:center; line-height:16px; padding:20px;">
                <a class="arial14grey"></a>
                </div>
            </div>
