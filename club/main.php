...
<head>
    <title>About the Club | Holmer Green Squash & Racketball Club</title>
    ...
    <div id="main">
        ...
        <div style="position:relative; float:left; width:1020px; height:auto;">
            <div id="altnav" style=" position:relative; float:left; left:285px; margin-top:10px; width:370px; height:auto; text-align:center;">
                <ul class="altnav">
                    <li><a class= "arial14dgrey" href="../club/club" style="">The Club</a></li>
                    <li><a class= "arial14dgrey" href="../club/contact">Contact</a></li>
                    <li><a class= "arial14dgrey" href="../club/location">Location</a></li>
                    <li><a class= "arial14dgrey" href="../club/AGM" style="">AGM</a></li>
                </ul>
            </div>
        </div>
