...
<head>
    <title>Racketball | Holmer Green Squash & Racketball Club</title>
	...
	<meta name="Description" content="Racketball"/>
        ...
        <div style="position:relative; float:left; width:1020px; height:auto;">
            <div id="altnav" style=" position:relative; float:left; left:285px; margin-top:10px; width:370px; height:auto; text-align:center;">
                <ul class="altnav">
                    ...
                    <li><a class= "arial14dgrey" href="../racketball/rules">Rules</a></li>
                </ul>
            </div>
        </div>
